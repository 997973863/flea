...
//    @RequestMapping(value = "/selectByKeyAndPassword",method = RequestMethod.POST,produces="application/json")
...
//        try {
//            logger.info("解密");
//            String userRsa = user.substring(5);
//            String jsonStr = RsaJsUtils.decryptByPrivateKeyData(userRsa);
